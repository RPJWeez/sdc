...
async function main() {
  try {
    ...
    console.log(
      `Saved ${uniqueStreams.length} unique streams across all games ` +
      `(from ${pageCount} pages) | Last updated: ${lastUpdated}`
    );
  } catch (error) {
